...
class MCPClient:
    def __init__(self, server_script_name: str) -> None:
...
class MCPClientManager:
    def __init__(self) -> None:
        self.clients = {
            "employee-db-mcp": MCPClient("employee_db_server.py"),
            "ticket-mcp": MCPClient("ticket_server.py"),
            "document-search-mcp": MCPClient("document_server.py")
        }

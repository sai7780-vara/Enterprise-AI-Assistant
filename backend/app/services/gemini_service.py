...
class GeminiService:
    def __init__(self) -> None:
        ...
        self.models = ["gemini-3.5-flash", "gemini-2.5-flash", "gemini-2.0-flash", "gemini-2.5-pro", "gemini-2.0-flash-lite"]
    ...
    def generate_reply(self, message: str) -> str:
        """Send one user message to Gemini, return the text reply. Rotates models on ResourceExhausted."""
        attempts = 0
        ...
        while attempts < max_attempts:
            ...
            try:
                ...
                attempts += 1
                logger.warning("ResourceExhausted on model %s. Rotating to next model...", model_name)
